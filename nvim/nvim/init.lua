...
require('lazy').setup({
  ...
  {
    -- Parser/query management for Neovim's native Treesitter features
...
local treesitter_languages = { 'bash', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'javascript', 'vimdoc', 'vim', 'markdown', 'markdown_inline', 'query' }
